...
contract InstaTimelockContract is Initializable, TimelockController {
    ...
    address public constant governanceTimelock =
        0xC7Cb1dE2721BFC0E0DA1b9D526bCdC54eF1C0eFC;

    constructor(address[] memory masterSig)
        public
        TimelockController(10 days, masterSig, masterSig)
    {}
