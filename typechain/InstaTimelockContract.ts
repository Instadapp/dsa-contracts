...
export interface InstaTimelockContractInterface extends utils.Interface {
  functions: {
    ...
    "governanceTimelock()": FunctionFragment;
...
export interface InstaTimelockContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstaTimelockContractInterface;
  ...
  functions: {
    ...
    governanceTimelock(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    governanceTimelock(overrides?: CallOverrides): Promise<BigNumber>;
