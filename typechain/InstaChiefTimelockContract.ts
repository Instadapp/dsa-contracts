...
export interface InstaChiefTimelockContractInterface extends utils.Interface {
  functions: {
...
export interface InstaChiefTimelockContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstaChiefTimelockContractInterface;
