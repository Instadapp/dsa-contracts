...
export interface InstaDefaultImplementationV2Interface extends utils.Interface {
  functions: {
...
export interface InstaDefaultImplementationV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstaDefaultImplementationV2Interface;
