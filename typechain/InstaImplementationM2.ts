...
export interface InstaImplementationM2Interface extends utils.Interface {
  functions: {
    "castWithFlashloan(string[],bytes[],address)": FunctionFragment;
    "connectorsM1()": FunctionFragment;
  };

  encodeFunctionData(
    functionFragment: "castWithFlashloan",
...
export interface InstaImplementationM2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstaImplementationM2Interface;
