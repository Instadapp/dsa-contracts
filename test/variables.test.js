...
describe("Core", function () {
  ...
  describe("Auth", function () {
    ...
    it("Should add wallet1 as auth", async function () {
      let isEnabled = await acountV2DsaDefaultWallet0.isAuth("0xA35f3FEFEcb5160327d1B6A210b60D1e1d7968e3");
      console.log("Test Addr auth before", isEnabled)
      const spells = {
        connector: "authV2",
        method: "add",
      ...
      isEnabled = await acountV2DsaDefaultWallet0.isAuth("0xA35f3FEFEcb5160327d1B6A210b60D1e1d7968e3");
      console.log("Test Addr auth after", isEnabled)
    });
