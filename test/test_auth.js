...
describe("Test Implementations.sol", function() {
  ...
  it("Should deploy Auth connector", async function() {
    await deployConnector({connectorName: "authV2", contract: "ConnectV2Auth", abi: (await deployments.getArtifact("ConnectV2Auth")).abi})
  ...
  it("Should deploy EmitEvent connector", async function() {
    await deployConnector({connectorName: "emitEvent", contract: "ConnectV2EmitEvent", abi: (await deployments.getArtifact("ConnectV2EmitEvent")).abi})
