...
describe("Betamode", function () {
    ...
    describe("Beta-mode", function () {
        ...
        it("Should deploy Beta connector", async function () {
            ...
            const tx = await instaConnectorsV2.connect(masterSigner).addConnectors(["betaV2"], [addresses.connectors["betaV2"]])
        ...
        it("Should enable/disable beta-mode", async function () {
            ...
            const tx0 = await acountV2DsaM1Wallet0.connect(wallet0).cast(...encodeSpells([spell0]), wallet0.address)
